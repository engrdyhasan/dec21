        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                ?>
                 ...
                 <div class="col-sm-3  author-status">
                 <?php the_author_posts_link(); ?> hase posted : <span class="posts-count"><?php echo count_user_posts(get_the_author_meta('ID')) ?> posts</span>
                    <hr>
    ...
    <!-- *************************************** -->
        ...
        <div class='author-comments'>
            <div class="row">
                ...
                <div class="col-sm-8"> 
                    <div class="post-content">
                    <?php// the_excerpt(22);  RADY25-9-2021?>
