...
// // ****************[54]*****************
// // ****************[str_word_count()]*****************
// $count = str_word_count($trimed);//number of words
// echo var_dump($count);
// echo "<pre>";
// print_r($count);
// echo "</pre>";
// echo str_repeat("#", 11)."<br/>";
// $count = str_word_count($trimed, 1);//
// echo var_dump($count);
// echo "<pre>";
// print_r($count);
// echo "</pre>";
// echo str_repeat("$",11)."<br/>";
// $count = str_word_count($trimed, 2);//indexed 
// echo var_dump($count);
// echo "<pre>";
// print_r($count);
// echo "</pre>";
...
// // ****************[55]*****************
// // *******************[ parse]**************
// $link = "name=engrdy&age=53&year=2021&skill=3&exp=4";
// // parse_str($link);
// // echo $name;
...
// // ******************[Nl2br,]***************
// $mystr = "name=engrdy\nage=53 \n year=2021 \n skill=3 \n exp=4";
// echo nl2br($mystr, true);
// echo "<br />". str_repeat("@#", 22)."<br />";
// // ***************[56]******************
// // ***************[strpos]******************
// $rdy = "I love php  SO much because PHP is a scipting language and PHP is famous and enteristing";
// $pos = strpos($rdy, "PHP");
// ECHO $pos."<br/>";
// $pos = strpos($rdy, "PHP", 8);
// ECHO $pos."<br/>";
// echo "<br />". str_repeat("*#", 22)."<br/>";
// $pos = stripos($rdy, "Php");
// ECHO $pos."<br/>";
// $pos = stripos($rdy, "Php", 8);
// ECHO $pos."<br/>";
// echo "<br />". str_repeat("*#", 22)."<br/>";
// $pos = strrpos($rdy, "php");
// ECHO $pos."<br/>";
// $pos = strrpos($rdy, "PHP", 8);
// ECHO $pos."<br/>";
// $pos = strrpos($rdy, "PHP", -47);
// ECHO $pos."<br/>";
// echo "<br />". str_repeat("*#", 22)."<br/>";
// // ****************[57]*****************
// // *******************[strstr]**************
// $mail = "engrdy@gmail.com";
// $name = strstr($mail, "@", true);
// $domain = strstr($mail, "@");
// $name = strchr($mail, "@", true);
// $domain = strchr($mail, "@");
// echo $mail."<br/>".$name."<br/>".$domain."<br/>";
// echo str_replace("@","",$domain)."<br/>";
// echo str_repeat("*@", 22)."<br/>";
// // *******************[stristr]**************
// $rdy = "I love php  SO much because PHP is a scipting language and PHP is famous and enteristing";
// $txt =stristr($rdy, "Php", true);
// echo $txt."<br />";
// $txt =stristr($rdy, "Php", false);
// echo $txt."<br />";
// // *****************[58]****************
// // ****************[strcom]*****************
// echo str_repeat("@#", 22)."<br/>";
...
// // ****************[59]*****************
// echo str_repeat("*@", 22)."<br/>";
// $drnourdy = "I love php  SO much because PHP is a scipting language and PHP is famous and enteristing";
// echo $drnourdy."<br />";
// $piece = substr($drnourdy, 6);
// echo $piece."<br />";
// $piece = substr($drnourdy, 0,3);
// echo $piece."<br />";
// $piece = substr($drnourdy, 2,3);
// echo $piece."<br />";
// $piece = substr($drnourdy, -5,3);
// echo $piece."<br />";
// $piece = substr($drnourdy, -5,-3);
// echo $piece."<br />";
// echo str_repeat("*@", 22)."<br/>";
...
$len = strlen($drnourdy);
echo $len."<br />";
$count = substr_count($drnourdy, "php");
echo $count."<br />";
$count = substr_count($drnourdy, "PHP", 5, $len-5);
echo $count."<br />";
// *********************************
echo str_repeat("*@", 22)."<br/>";
$a = "sRady";
$b = "hasan";
echo substr_compare($a,$b,0)."<br />";
echo substr_compare($a,$b,0,true)."<br />";
echo substr_compare($a,$b,1)."<br />";
